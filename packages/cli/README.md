...
| `--material`                        | For `diff`, ignore `description` fields and `x-` extension properties at every level. Use it when reviewing contract changes without editorial or tool-specific metadata.                                                |
