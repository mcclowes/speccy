...
function LanguageIcon({ language }: { language: RequestSampleLanguage }): ReactNode {
  if (language === 'curl') return <svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M.803 14.817a.966.966 0 1 1 1.933 0 .966.966 0 0 1-1.933 0m.967-7.149a.966.966 0 1 1 0 1.933.966.966 0 0 1 0-1.933m13.22-2.958a.966.966 0 1 1 0-1.933.966.966 0 0 1 0 1.933M5.391 21.223a.966.966 0 1 1 0-1.933.966.966 0 0 1 0 1.933M14.991 1.974c-.978 0-1.77.792-1.77 1.77 0 .208.053.402.119.588L5.039 18.558a1.77 1.77 0 1 0 2.01 1.146L15.392 5.43a1.77 1.77 0 1 0-.401-3.457m7.24 2.736a.966.966 0 1 1 0-1.933.966.966 0 0 1 0 1.933m-9.6 16.513a.966.966 0 1 1 0-1.933.966.966 0 0 1 0 1.933M22.23 1.974a1.77 1.77 0 0 0-1.65 2.358L12.279 18.558a1.77 1.77 0 1 0 2.01 1.146L22.632 5.43a1.77 1.77 0 0 0-.401-3.457" /></svg>;
