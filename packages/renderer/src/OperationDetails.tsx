...
export function SecurityRequirements({ requirements, schemes }: {
...
export function GroupedParameterList({ parameters, parameterPrototype }: { parameters: Parameter[]; parameterPrototype?: boolean }) {
...
export function EndpointResponses({ responses }: { responses: Record<string, ResponseObject> }) {
