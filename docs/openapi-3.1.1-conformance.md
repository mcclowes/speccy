...
| Components: schemas, responses, parameters, examples, request bodies, headers, security schemes, links, callbacks, and Path Items | Supported | `OpenApi311.test.tsx`, reference-section coverage in `Speccy.test.tsx`                                   |
